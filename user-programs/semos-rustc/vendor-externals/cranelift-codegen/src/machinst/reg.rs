...
// Note: `Debug` is provided by the manual impl below (line ~114),
// which formats the register as virtual/real/spillslot for readability.
// `Debug` derive would conflict. The original Linux/upstream code
// relies on the manual impl too.
