...
// M27 R4: std::sync::LazyLock is now provided by semos_std::sync::LazyLock
// (landed in commit c9f0b2d as part of the C3-followup prep). Same
// `LazyLock<T, fn() -> T>` shape as the C3 inline shim it replaces.
