...
// D.2 port: keep unwind module unconditional (consumers use UnwindInst
// + UnwindInfoKind), but its CfaUnwindInfo (which references gimli-backed
// systemv submodule) is now gated inside unwind.rs.
pub mod unwind;
