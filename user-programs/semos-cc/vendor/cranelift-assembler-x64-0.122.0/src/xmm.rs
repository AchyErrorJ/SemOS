...
// D.2 port: alloc prelude for no_std.
use alloc::{string::{String, ToString}, vec::Vec, format, boxed::Box, vec, borrow::ToOwned};
...
pub mod enc {
    use alloc::{string::{String, ToString}, vec::Vec, format, boxed::Box, vec, borrow::ToOwned, borrow::Cow};
    pub const XMM0: u8 = 0;
    pub const XMM1: u8 = 1;
    pub const XMM2: u8 = 2;
    pub const XMM3: u8 = 3;
