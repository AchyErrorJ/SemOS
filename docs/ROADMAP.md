...
## M27 — First rustc build on Semantic OS `[🔨 Phase 5c Stage G iter 5b in progress — Cranelift port: 19 sub-crates vendored, gimli FIXED, cranelift-codegen down from 7000+ errors to 430 (iter 6 target: regalloc2::Reg Debug + body-level std:: sweep + OnceLock shim)]`
