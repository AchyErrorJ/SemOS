//! Legacy boot/demo functions extracted from `main.rs`.
//!
//! These remain kernel-mode regression demos for now, but keeping them out of
//! `main.rs` shrinks the boot file and makes the review's TCB-bloat follow-up
//! explicit. New demos should go in `demos.rs`; older demos can be moved here
//! incrementally until they become user programs.
...
pub(crate) fn seed_persistent_object(
...
pub(crate) fn llm_streaming_test() {
...
pub(crate) fn security_policy_test() {
...
pub(crate) fn context_aware_redaction_test() {
...
pub(crate) fn network_llm_provider_test() {
    use kernel_core::llm::{
...
pub(crate) fn user_identity_test() {
    use kernel_core::syscall::{dispatch, numbers::*};
...
pub(crate) fn tls_verifier_test() {
...
///     in-QEMU TLS server.
pub(crate) fn tls_transport_smoke() {
...
pub(crate) fn aead_kat_test() -> bool {
...
pub(crate) fn tls_live_handshake() {
    use kernel_core::net::Ipv4Address;
    use kernel_core::llm::transport::NetworkTransport;
    use kernel_core::tls::transport_tls::{configure_global, global_tls_transport};
...
pub(crate) fn dns_resolver_demo() {
...
pub(crate) fn paths_namespace_test() {
...
pub(crate) fn fs_persistence_test() {
...
pub(crate) fn large_file_fwrite_test() {
    use kernel_core::syscall::{dispatch, StatX};
    use kernel_core::syscall::numbers::*;
    use kernel_core::syscall::open_flags;
    ...
    let mut big = alloc::boxed::Box::new([0u8; 8192]);
...
pub(crate) fn threading_futex_test() {
    use kernel_core::syscall::dispatch;
    use kernel_core::syscall::numbers::*;
    use core::sync::atomic::Ordering;
...
pub(crate) fn ring3_cg_clif_demo() {
    use kernel_core::syscall::{dispatch, numbers::*};
...
pub(crate) fn ring3_semos_cc_demo() {
    use kernel_core::syscall::{dispatch, numbers::*};
...
pub(crate) fn ring3_spawn_capture(path: &str, cap: &mut [u8]) -> Option<(u32, usize)> {
    use kernel_core::syscall::{dispatch, numbers::*};
...
pub(crate) fn ring3_semos_cc_d2_demo() {
    let saved_kernel_task = kernel_core::process::kernel_task_id();
    kernel_core::process::set_kernel_task_id(Some(kernel_core::scheduler::current_task_index()));
...
pub(crate) fn ring3_thread_demo() {
    use kernel_core::syscall::{dispatch, numbers::*};
...
pub(crate) fn heap_allocator_test() {
    use kernel_core::syscall::dispatch;
    use kernel_core::syscall::numbers::*;
...
pub(crate) fn write_u32_decimal(n: u32, buf: &mut [u8; 8]) -> &[u8] {
...
pub(crate) fn test_policy_syscalls() {
...
pub(crate) fn spawn_named(path: &str) { spawn_named_at(path, 0); }

pub(crate) fn spawn_named_at(path: &str, tier: u64) {
...
#[inline(always)]
pub(crate) fn user_syscall(num: u64, arg0: u64, arg1: u64, arg2: u64, arg3: u64) -> u64 {
    let result: u64;
    unsafe {
        core::arch::asm!(
            "syscall",
